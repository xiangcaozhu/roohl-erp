...
//include ‘PHPExcel/Writer/Excel2007.php’;用于输出.xlsx的
...
直接输出到浏览器
$objPHPExcel->saveDown5(文加名)
保存在服务器
$objPHPExcel->saveServer5(文加名)
