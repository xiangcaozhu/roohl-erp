...
$OrderControlFlow['order.allow.order.cancel'] = array(
	'text' => '设置:取消订单',
	'type' => 1,
...
$OrderControlFlow['order.allow.order.uncancel'] = array(
	'text' => '取消:取消订单',
	'type' => 0,
...
$OrderControlFlow['order.allow.order.processing'] = array(
	'text' => '设置:准备发货',
	'type' => 1,
...
$OrderControlFlow['order.allow.order.unprocessing'] = array(
	'text' => '取消:准备发货',
	'type' => 0,
...
$OrderControlFlow['order.allow.order.done'] = array(
	'text' => '设置:已经完成',
	'type' => 1,
...
$OrderControlFlow['order.allow.order.undone'] = array(
	'text' => '取消:已经完成',
	'type' => 0,
...
$OrderControlFlow['order.allow.pay.confirm'] = array(
	'text' => '设置:已经支付',
	'type' => 1,
...
$OrderControlFlow['order.allow.pay.unconfirm'] = array(
	'text' => '取消:已经支付',
	'type' => 0,
...
$OrderControlFlow['order.allow.paycheck.confirm'] = array(
	'text' => '设置:确认到账',
	'type' => 1,
	...
	'global_status' => 3,
	'call' => '_OrderPaymentConfirmed',
);

$OrderControlFlow['order.allow.paycheck.unconfirm'] = array(
	'text' => '取消:确认到账',
	'type' => 0,
...
$OrderControlFlow['order.allow.paycheck.review'] = array(
	'text' => '设置:付款异常',
	'type' => 1,
...
$OrderControlFlow['order.allow.paycheck.unreview'] = array(
	'text' => '取消:付款异常',
	'type' => 0,
...
$OrderControlFlow['order.allow.pay.back'] = array(
	'text' => '设置:已经退款',
	'type' => 1,
	'allow' => 'order.allow.pay.back',
	'condition' => array( 3 ),
	'data' => array(
...
$OrderControlFlow['order.allow.pay.unback'] = array(
	'text' => '取消:已经退款',
	'type' => 0,
	'condition' => array( 9 ),
	'allow' => 'order.allow.pay.unback',
	'data' => array(
		'pay_status' => PAY_STATUS_PAID,
		'pay_status_time' => time(),
	),
...
$OrderControlFlow['order.allow.ship.pack'] = array(
	'text' => '设置:正在打包',
	'type' => 1,
...
$OrderControlFlow['order.allow.ship.unpack'] = array(
	'text' => '取消:正在打包',
	'type' => 0,
...
$OrderControlFlow['order.allow.ship.confirm'] = array(
	'text' => '设置:已经发货',
	'type' => 1,
...
$OrderControlFlow['order.allow.ship.unconfirm'] = array(
	'text' => '取消:已经发货',
	'type' => 0,
...
$GLOBALS['__Config']['order_control_flow'] = $OrderControlFlow;
