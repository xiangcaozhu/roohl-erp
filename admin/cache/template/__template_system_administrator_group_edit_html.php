...
* Created on : 2013-07-04 05:47:51
*/
?>
		...
		<table cellspacing="0" class="HY-form-table-table">
			<tbody>
				<tr>
					...
					<td class="value"><input name="name" id="name" value="<?php echo $group['name']; ?>" class="input-text" type="text" style=""/></td>
					<td><small>&nbsp;</small></td>
				</tr>
				<tr>
...
tree.globalUrl = "?mod=product.category.edit&id=<id>";
tree.hcnExpand = true;
tree.nodeLink = false;
...
tree.nodeCheckBoxCheckedList = '<?php echo $group['allow']; ?>'.split(',');
tree.lineHeight = 18;
