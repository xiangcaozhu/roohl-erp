...
* Created on : 2013-10-11 14:55:39
*/
?>
...
<div class="HY-grid-title" style="display:none">
...
?>
			...
			<td align="center"><?php echo $supplierinfo['id']; ?></td>
				...
				<td >
				<a href="?mod=purchase.supplierInvoice&id=<?php echo $supplierinfo['id']; ?>" target="_blank">管理</a><br />
				已开：<?php echo FormatMoney($supplierinfo['supplier_invoice']); ?><br />
				未开：<?php echo FormatMoney($supplierinfo['supplier_invoice_no']); ?>
				</td>
			</tr>
			<?php
}
