...
* Created on : 2013-01-08 15:29:50
*/
?>
<?php if ( !defined( 'IN_NTP' ) ) exit( 'Access Denied' ); ?>
<div class="HY-content-header clearfix">
	<h3 class="head-tax-rule">业务部毛利统计查询 </h3>
</div>
...
<div class="HY-form-table" id="price_tab">
	...
	<div class="HY-form-table-main">
		<table cellspacing="0" class="HY-form-table-table">
			<tbody>
				<tr>
					<td class="label"><label>到账日期开始<span class="required"></span></label></td>
					<td class="value">
				...
				<tr>
					<td class="label"><label>到账日期结束<span class="required"></span></label></td>
					<td class="value">
