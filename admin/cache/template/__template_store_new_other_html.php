...
* Created on : 2013-01-08 15:28:27
*/
?>
	...
	<table cellspacing="0">
		<thead>
			<tr class="header">
				...
				<th width="190">入库数量</th>
				<th width="120">入库价格</th>
				<th width="130">入库货位</th>
				<th width="220">备注</th>
				<th width="120">操作</th>
			</tr>
		</thead>
...
function SubmitForm(){
	...
	Loading();
	$.ajax({
		url: '?mod=store.new.other<?php echo $warehouse_uri; ?>&rand=' + Math.random(),
		type:'POST',
		data:post,
