...
* Created on : 2013-07-11 01:04:49
*/
?>
		...
		<table cellspacing="0" class="HY-form-table-table">
			<tbody>
				<tr>
					...
					<td class="value"><input name="user_name" id="user_name" value="" class="input-text" type="text" style=""/></td>
					<td><small>&nbsp;</small></td>
				</tr>
				<tr>
				...
				<tr>
					...
					<td class="value"><input name="user_real_name" id="user_real_name" value="" class="input-text" type="text" style=""/></td>
					<td><small>&nbsp;</small></td>
				</tr>
				<tr>
