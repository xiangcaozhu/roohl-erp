...
* Created on : 2016-07-14 18:16:45
*/
?>
	...
	<div class="right">
		<table>
			<tr>
				...
				<td>&nbsp;&nbsp;&nbsp;发往仓库：★代发货　　　　<input type="hidden" id="warehouse_id" name="warehouse_id" value="5" />
...
{
?>
<input type="hidden" class="input-text" style="width:100px;" name="orderID[]" value="<?php echo $row['order_id']; ?>">
