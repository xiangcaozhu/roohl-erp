...
* Created on : 2014-01-03 15:10:27
*/
?>
<?php if ( !defined( 'IN_NTP' ) ) exit( 'Access Denied' ); ?>
<div class="HY-content-header clearfix">
	<h3 class="head-tax-rule">广发银行月报（孙江琳）</h3>
</div>
	...
	<table cellspacing="0" class="data" id="grid_table">
		<thead>
			<tr class="header">
				...
				<td align="center" width="100">有效成功<br />数量/总金额</td>
				<td align="center" width="100">外呼取消<br />数量/总金额</td>
				<td align="center" width="100">售后退货中<br />数量/总金额</td>
				<td align="center" width="100">售后退货完毕<br />数量/总金额</td>
				<td align="center" width="100">全部信息<br />数量/金额</td>
				<td align="left" >&nbsp;</td>
			</tr>
		</thead>
<?php
...
<td align="center"><?php echo $val['nowday']; ?></td>
<td align="center"><?php echo $val['totalNum']; ?><br /><?php echo $val['totalMoney']; ?></td>
<td align="center"><?php echo $val['totalNum_del']; ?><br /><?php echo $val['totalMoney_del']; ?></td>
<td align="center"><?php echo $val['totalNum_re']; ?><br /><?php echo $val['totalMoney_re']; ?></td>
<td align="center"><?php echo $val['totalNum_reover']; ?><br /><?php echo $val['totalMoney_reover']; ?></td>
<td align="center"><?php echo $val['totalNums']; ?><br /><?php echo $val['totalMoneys']; ?></td>
<td>
<?php
if ( $val['orderList'] )
{
...
{
?>
<span style="float:left; padding-right:15px;"><a title="<?php echo $row['orderTargetID']; ?>" href="?mod=order.list_all&id=<?php echo $row['orderID']; ?>" target="_blank"><?php echo $row['orderID']; ?></a></span>
<?php
}
}
?>
