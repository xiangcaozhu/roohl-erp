...
* Created on : 2013-01-08 15:00:18
*/
?>
...
<div class="HY-main-columns clearfix">
	...
	<div class="HY-main-columns-right">
		<div class="HY-content-header clearfix">
			<h3>移动产品 - 选择一个分类(当前分类:<?php echo $category['name']; ?>)</h3>
		</div>
...
Ext.onReady(function(){
	...
	tree.on('click',function(node,e){
		...
		window.location='?mod=product.move&id=<?php echo $product['id']; ?>&cid={0}&fcid=<?php echo $_GET['fcid']; ?>'.format(id);
	});
