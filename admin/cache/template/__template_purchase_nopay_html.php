...
* Created on : 2013-09-17 15:12:59
*/
?>
...
{
?>
	<button type="button" onclick="$('#mainform').attr('action','?mod=purchase.print_all&supplierId=<?php echo $_GET['supplierId']; ?>');$('#mainform').submit();">打印采购单</button>
	<button type="button" onclick="$('#mainform').attr('action','?mod=purchase.printZC_all&supplierId=<?php echo $_GET['supplierId']; ?>');$('#mainform').submit();">预览支出单</button>
...
<table width="100%" border="0" cellpadding="0" cellspacing="0">
  <tr>
    <td align="left" width="30"><input type="checkbox" name="purchase_list_Id[]" value="<?php echo $val['id']; ?>"></td>
