...
* Created on : 2013-01-07 18:03:19
*/
?>
...
<div class="HY-grid-title">
	<div class="HY-grid-title-inner">
		订单回款明细 (<?php echo $_GET['begin_date']; ?> - <?php echo $_GET['end_date']; ?>) 总共<?php echo $total; ?>条记录
	</div>
</div>
<div class="HY-grid">
...
?>>未开发票</option>
		...
		<tbody>
			<form method="post" action="?mod=finance.recieve.detail.print&channel_id=<?php echo $_GET['channel_id']; ?>&begin_date=<?php echo $_GET['begin_date']; ?>&end_date=<?php echo $_GET['end_date']; ?>&order_invoice_status=<?php echo $_GET['order_invoice_status']; ?>&channel_parent_id=<?php echo $_GET['channel_parent_id']; ?>" id="main_form">
			<?php
if ( $list )
{
...
?></td>
				...
				<td align="right"><?php echo FormatMoney($info['payout']); ?></td>
				<td align="right"><?php echo FormatMoney($info['balance']); ?></td>
