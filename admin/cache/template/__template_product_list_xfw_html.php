...
* Created on : 2013-11-25 16:58:21
*/
?>
...
{
?>
<a href="?mod=product.edit&id=<?php echo $product['id']; ?>&cid=<?php echo $_GET['cid']; ?>">编辑</a><br /><a href="?mod=product.move&id=<?php echo $product['id']; ?>&fcid=<?php echo $product['cid']; ?>">移动</a>
<?php
}
else
{
