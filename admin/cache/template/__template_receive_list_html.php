...
* Created on : 2013-02-26 11:27:14
*/
?>
<?php if ( !defined( 'IN_NTP' ) ) exit( 'Access Denied' ); ?>
<div class="HY-content-header clearfix">
	<h3 class="head-tax-rule"><?php echo $warehouse_info['name']; ?> 收货单列表 </h3>
	<p class="right">
		<button  id="" type="button" class="scalable back" onclick="window.location='?mod=purchase.new.general';" style=""><span>新建常规采购</span></button>
	</p>
</div>
...
?></td>
				...
				<td >
					<a href="?mod=receive.view<?php echo $warehouse_uri; ?>&id=<?php echo $val['id']; ?>">查看</a>
					<a href="?mod=receive.edit<?php echo $warehouse_uri; ?>&id=<?php echo $val['id']; ?>">修改</a>
					<a href="?mod=receive.del<?php echo $warehouse_uri; ?>&id=<?php echo $val['id']; ?>" onclick="return confirm('确定删除吗?');">删除</a>
				</td>
			</tr>
			<?php
}
