	...
	************************************************************************************************************/	
	...
	var form_widget_amount_slider_handle = 'image/colorpicker/slider_handle.gif';
		...
		do{			
			if(subDiv.tagName=='DIV' && subDiv.className!='colorPickerCloseButton'){
				if(subDiv==thisObj){
					...
					img.src = "image/colorpicker/tab_right_active.gif"
					...
					img.src = "image/colorpicker/tab_right_inactive.gif";
					if(activeColorDiv)
	...
	function createColorPickerTopRow(inputObj){
		...
		for(var no=0;no<tabs.length;no++){			
			...
			tabImg.src = "image/colorpicker/tab_right_" + suffix + ".gif";
