...
if ( $_GET['excel'] )
{
	...
	foreach ( $list as $val )
	{
		$excelList[] = array(
			...
			'delivery_time' => DateFormat( $val['delivery_time'] ),
...
//	echo ExcelXml( $header, $excelList, '', array( 'id', 'channel_parent_name', 'channel_name', 'delivery_time', 'order_invoice_status', 'product_name', 'sales_price', 'sales_quantity', 'total_sales_price', 'stock_price', 'stock_quantity', 'total_stock_price' ) );
	exit;
}
...
Common::PageOut( 'finance/order.html', $tpl );
