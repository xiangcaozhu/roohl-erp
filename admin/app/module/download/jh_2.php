...
if ( !$_POST )
{
	...
	Common::PageOut( 'download/jh_2.html', $tpl );
}
else
{
	...
	$list = $CenterOrderModel->GetDownload_jh_1( $beginTime, $endTime,61 );
		...
		$orderList = array();
		if($val['targetID'])
		$orderList  = $CenterOrderModel->GetDownload_jh_1_1( $beginTime, $endTime,61,$val['productID'],$val['productMoney'],$val['targetID'],$val['orderStatus'],$val['orderService'] );
