...
$begin_dates = $_GET['begin_date'] ? strtotime( $_GET['begin_date'] . ' 00:00:00' ) : (time()-2678400);
$begin_date = DateFormat($begin_dates,'Y-m-d');

$tpl['begin_date'] = $begin_date;
...
foreach ( $list as $key => $val )
{
	...
	$list[$key]['sign_time'] = DateFormat( $val['sign_time'],'Y-m-d');
	$list[$key]['logistics_time'] = $val['logistics_time'] ? DateFormat( $val['logistics_time'] ) : '';
